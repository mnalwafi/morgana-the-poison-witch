...
public class Stage2 extends World
{
    ...
    public Stage2(String difficulties, int currentHealth)
    {    
        super(300, 500, 1); 
        GreenfootImage bg = new GreenfootImage("BGev.png");
        ...
        backgroundMusic = new GreenfootSound("evening ambience.mp3");
    ...
    {
        kucing kucing = new kucing(this.GameDifficulties, "Stage 2");
